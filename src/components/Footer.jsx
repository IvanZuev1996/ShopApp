    ...
    <div className='footer-container'>
        <div className="footer-left">
            ...
            <p className="footer-desc">
                When ordering delivery in Moscow and beyond the MKAD 
                (to the concrete ring), you can order two sizes of one 
                product for fitting and choose the one that fits.
            </p>
        ...
        <div className="footer-right">
            ...
            <div className="footer-contact-items">
                ...
                <div className="contact-item">
                    <div className="contact-icon"><LocalPhone/></div>
